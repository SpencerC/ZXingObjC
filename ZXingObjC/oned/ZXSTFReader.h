...
extern const int ZX_STF_PATTERNS[][5];

/**
 * Implements decoding of the STF format, or Interleaved Two of Five.
 *
 * This Reader will scan STF barcodes of certain lengths only.
 ...
 */
@interface ZXSTFReader : ZXOneDReader
